...
export const tweetsDataSchema = Type.Pick(tweetsSchema, ['content','userId'], {
  $id: 'TweetsData'
})
...
export const tweetsQueryProperties = Type.Pick(tweetsSchema, ['id', 'content', 'likes', 'userId','createdAt','updatedAt'])
